...
class ActivityLogViewModel(activityRepository: ActivityRepository) : ViewModel() {

    val activityLogUiState: StateFlow<ActivityLogUiState> =
        activityRepository.getAllActivitiesStream().map { ActivityLogUiState(it) }
            .stateIn(
